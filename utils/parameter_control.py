...
class ResnetParamControl(GenericParamControl):
    ...
    def init_module_list(self):
        ...
        # 4-10 are the output layers. 163-187 are the layer4 of Resnet 50. 142-163 are half of the layer3 of Resnet 50.
    ...
    def release_param(self, model, epoch=0):
        if self.gradual_release:
            ...
            print("Early stopped since no gradual release employed!")
            self.early_stop = True
